...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className='home__title'>Abd Essamad Baaziz
          <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <h3 className='home__subtitle'>Softwer Developer</h3>
        <p className='home__description'>I'm a Creative Softwer Developer / UI/UX Designer Based in Morocco, and I'm Very passionate and dedicated to my work.</p>
